import{j as e}from"./iframe-C8s8EPpo.js";import{B as p}from"./bot-CnIkOJjn.js";import{L as u}from"./loader-circle-de2d1qAN.js";import"./preload-helper-PPVm8Dsz.js";import"./createLucideIcon-C1GSK0_N.js";const t=()=>e.jsx("div",{className:"fixed inset-0 z-50 bg-gradient-to-br from-black via-black to-indigo-950/20 flex items-center justify-center",children:e.jsxs("div",{className:"text-center space-y-4",children:[e.jsxs("div",{className:"relative",children:[e.jsx("div",{className:"absolute inset-0 bg-indigo-500/20 blur-2xl rounded-full animate-pulse"}),e.jsx(p,{size:64,className:"relative mx-auto animate-bounce"})]}),e.jsx("p",{className:"text-white/60",children:"Загрузка..."})]})}),i=()=>e.jsx("div",{className:"flex items-center justify-center h-full w-full bg-black text-white",children:e.jsxs("div",{className:"text-center space-y-6",children:[e.jsxs("div",{className:"relative w-16 h-16 mx-auto",children:[e.jsx("div",{className:"absolute inset-0 bg-indigo-500/30 blur-xl rounded-full animate-pulse"}),e.jsx("div",{className:"relative animate-spin rounded-full h-16 w-16 border-[3px] border-white/20 border-t-indigo-400"})]}),e.jsx("div",{className:"space-y-2",children:e.jsx("p",{className:"text-base text-white/80 font-medium",children:"Загружаем..."})})]})}),l=({message:m="Загрузка..."})=>e.jsx("div",{className:"flex items-center justify-center p-8 bg-black/30 rounded-lg",children:e.jsxs("div",{className:"text-center space-y-3",children:[e.jsx(u,{size:32,className:"mx-auto animate-spin text-indigo-400"}),e.jsx("p",{className:"text-sm text-white/60",children:m})]})}),c=i;t.__docgenInfo={description:`Компонент загрузки для модальных окон
