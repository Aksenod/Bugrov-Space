...
export const AlertDialog: React.FC<AlertDialogProps> = ({
  ...
  return (
    ...
    >
      ...
      {/* Alert */}
      <div className={`relative w-full max-w-md bg-black/80 backdrop-blur-2xl border border-white/10 rounded-[2rem] ${config.glow} animate-in fade-in slide-in-from-top-4 duration-300 overflow-hidden pointer-events-auto`}>
