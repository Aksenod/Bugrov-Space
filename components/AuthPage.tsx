  ...
  return (
    <div className="min-h-screen w-full flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        {/* Card */}
        <div className="bg-black/40 backdrop-blur-3xl border border-white/10 rounded-[2rem] shadow-2xl overflow-hidden relative group animate-in fade-in slide-in-from-bottom-4 duration-500">
                ...
                <div className="space-y-1.5 group/input">
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className={`w-full bg-black/20 border rounded-xl py-3.5 pl-11 pr-10 text-white placeholder-white/20 focus:outline-none focus:ring-2 transition-all ${
                        touched.username && usernameError 
                          ? 'border-red-500/50 focus:ring-red-500/50' 
                          : touched.username && !usernameError && username
                          ? 'border-emerald-500/50 focus:ring-emerald-500/50'
                          : 'border-white/10 focus:ring-indigo-500/50 focus:border-transparent'
                      }`}
                      placeholder="johndoe"
                    />
                    {touched.username && !usernameError && username && (
                  ...
                  <div className="space-y-1.5 group/input">
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        className={`w-full bg-black/20 border rounded-xl py-3.5 pl-11 pr-11 text-white placeholder-white/20 focus:outline-none focus:ring-2 transition-all ${
                  ...
                  <div className="space-y-1.5 group/input animate-in slide-in-from-bottom-2">
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        className="w-full bg-black/20 border border-white/10 rounded-xl py-3.5 pl-11 pr-11 text-white placeholder-white/20 focus:outline-none focus:ring-2 focus:ring-indigo-500/50 focus:border-transparent transition-all"
