    ...
    <div className="w-full max-w-3xl mx-auto relative group">
      ...
      <div className="relative flex items-end bg-gradient-to-br from-black/70 via-black/60 to-black/70 backdrop-blur-xl border border-white/10 rounded-[1.5rem] shadow-2xl shadow-indigo-500/10 transition-all group-focus-within:border-white/20 group-focus-within:shadow-indigo-500/30 group-focus-within:shadow-lg">
        ...
        <textarea
          ...
          disabled={disabled}
          className="w-full bg-transparent text-white placeholder-white/30 text-sm px-3 py-3.5 max-h-[150px] min-h-[48px] focus:outline-none focus:ring-0 resize-none overflow-y-auto scrollbar-hide font-medium leading-relaxed"
          rows={1}
        />
        <div className="pr-1.5 pb-1.5">
          <button
            ...
            className={`p-2.5 rounded-full flex-shrink-0 transition-all duration-300 ease-out will-change-transform ${
              !input.trim() || disabled
